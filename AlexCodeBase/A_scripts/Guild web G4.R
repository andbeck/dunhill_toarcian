...
ex_taxonlist<-read.csv("./data/G4_guilds.csv")
...
write.csv(inferred_web, "./outputs/interactions/G4 - late recovery guild inferred web.csv")
...
write.csv(trophiclevels, "./outputs/trophic levels/G4 - trophic levels.csv")
...
write.csv(stats_inferred_web_network_level, "./outputs/network stats/G4 - networks stats.csv")

#Node-level statistics
stats_inferred_web_node_level<-calc_node_stats(graph_inferred_web)
head(stats_inferred_web_node_level)

write.csv(stats_inferred_web_node_level, "./outputs/node stats/G4 - node stats.csv")
...
write.csv(stats_inferred_web_motif_level, "./outputs/motif stats/G4 - motif stats.csv")

#Calculate selected stats for Toarcian study
toarcian_stats<-calc_select_stats(graph_inferred_web)
head(toarcian_stats)

write.csv(toarcian_stats, "./outputs/toarcian stats/G4 - toarcian stats.csv")
