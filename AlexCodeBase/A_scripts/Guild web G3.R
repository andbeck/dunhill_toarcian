...
ex_taxonlist<-read.csv("./data/G3_guilds.csv")
...
write.csv(inferred_web, "./outputs/interactions/G3 - early recovery guild inferred web.csv")
...
#NAs indicate that a rule was aren't met
...
write.csv(trophiclevels, "./outputs/trophic levels/G3 - trophic levels.csv")
...
write.csv(stats_inferred_web_network_level, "./outputs/network stats/G3 - networks stats.csv")

#Node-level statistics
stats_inferred_web_node_level<-calc_node_stats(graph_inferred_web)
head(stats_inferred_web_node_level)

write.csv(stats_inferred_web_node_level, "./outputs/node stats/G3 - node stats.csv")
...
write.csv(stats_inferred_web_motif_level, "./outputs/motif stats/G3 - motif stats.csv")

#Calculate selected stats for Toarcian study
toarcian_stats<-calc_select_stats(graph_inferred_web)
head(toarcian_stats)

write.csv(toarcian_stats, "./outputs/toarcian stats/G3 - toarcian stats.csv")
