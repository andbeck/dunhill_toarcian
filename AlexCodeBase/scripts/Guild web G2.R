...
ex_taxonlist<-read.csv("./data/G2_guilds.csv")
...
write.csv(inferred_web, "./outputs/interactions/G2 - post-extinction guild inferred web.csv")
...
write.csv(trophiclevels, "./outputs/trophic levels/G2 - trophic levels.csv")
...
write.csv(stats_inferred_web_network_level, "./outputs/network stats/G2 - networks stats.csv")

#Node-level statistics
stats_inferred_web_node_level<-calc_node_stats(graph_inferred_web)
head(stats_inferred_web_node_level)

write.csv(stats_inferred_web_node_level, "./outputs/node stats/G2 - node stats.csv")
...
write.csv(stats_inferred_web_motif_level, "./outputs/motif stats/G2 - motif stats.csv")

#Calculate selected stats for Toarcian study
toarcian_stats<-calc_select_stats(graph_inferred_web)
head(toarcian_stats)

write.csv(toarcian_stats, "./outputs/toarcian stats/G2 - toarcian stats.csv")
